...
Warning: Starting with 0.8.0 Spex is much less opinionated and uses AIOM+ over the Minify Module, please compare your pre 0.8.0 with the new 0.8.0 _base layout.
